...
// ... Temporary before cleaning
      ERR_API_OUTBOUNDS        = 531,
      ERR_API_INPUTNOTOPEN     = 532,
      ERR_API_SIM_NRUNNING     = 533,
      ERR_API_WRONG_TYPE       = 534,
      ERR_API_POLLUT_INDEX     = 536,
      ERR_API_INFLOWTYPE       = 537,
      ERR_API_TSERIES_INDEX    = 538,
      ERR_API_PATTERN_INDEX    = 539,
      ERR_API_LIDUNIT_INDEX    = 540,
      ERR_API_UNDEFINED_LID    = 541,
      ERR_API_MEMORY           = 542,
