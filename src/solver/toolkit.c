...
{
    cstr_duplicate(errorMsg, error_getMsg(errorCode, *errorMsg));
    return 0;
}
    ...
    else
    {
        switch(param)
        {
            ...
            case SM_OFFSET1:
                ...
                {
                    ErrorCode = ERR_API_SIM_NRUNNING; break;
                }
...
// Purpose: Gets Lid Unit Parameter
{
    ...
    {
        lidUnit = lid_getLidUnit(index, lidIndex, &ErrorCode);
        ...
        if(lidUnit)
        {
            switch(param)
            {
                ...
                default:
                    ErrorCode = ERR_API_OUTBOUNDS; break;
            }
        }
    }
...
// Purpose: Gets Lid Unit Water Balance Simulated Value at Current Time
{
    ...
    else
    {
        ...
        {
            ErrorCode = ERR_API_UNDEFINED_LID;
        }
    }
    return ErrorCode;
}
...
/// Purpose: Sets new node inflow rate and holds until set again
{
    ...
    else
    {
        ...
        if (!inflow)
        {
            ...
            ErrorCode = inflow_setExtInflow(index, param, type, tSeries,
