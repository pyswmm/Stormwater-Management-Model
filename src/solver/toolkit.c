...
int EXPORT_TOOLKIT swmm_setNodeOpening(int nodeID, int idx, int oType, double A,
...
// Purpose: Sets Node opening parameters.
{
    ...
    else
    {
        ...
        u_l = l / UCF(LENGTH);
        error_code = coupling_setOpening(nodeID, idx, oType, u_A, u_l, Co, Cfw, Csw);
    }
    return error_code;
}

int EXPORT_TOOLKIT swmm_deleteNodeOpening(int nodeID, int idx)
//
// Input:   nodeID = Index of desired node
//          idx    = opening's index
// Return:  Error code
...
int EXPORT_TOOLKIT swmm_getNodeOpeningParam(int nodeID, int idx, int Param, double *value)
//
// Input:   nodeID = Index of desired node
//          idx    = opening's index
...
int EXPORT_TOOLKIT swmm_getNodeOpeningFlow(int nodeID, int idx, double *inflow)
//
// Input:   nodeID = Index of desired node
//          idx    = opening's index
...
int EXPORT_TOOLKIT swmm_getNodeOpeningType(int nodeID, int idx, int *type)
//
// Input:   nodeID = Index of desired node
//          idx    = opening's index
...
int EXPORT_TOOLKIT swmm_getOpeningCouplingType(int nodeID, int idx, int *coupling)
//
// Input:   nodeID   = Index of desired node
//          idx      = opening's index
...
int EXPORT_TOOLKIT swmm_getOpeningsNum(int nodeID, int *num)
//
// Input:   nodeID   = Index of desired node
...
int EXPORT_TOOLKIT swmm_getOpeningsIndices(int nodeID, int arr_size, int *arr)
//
// Input:   nodeID   = Index of desired node
...
int EXPORT_TOOLKIT swmm_getNodeIsCoupled(int nodeID, int *iscoupled)
//
// Input:   nodeID = Index of desired node
// Return:  API error
...
int EXPORT_TOOLKIT swmm_closeOpening(int nodeID, int idx)
//
// Input:   nodeID = Index of desired node
// Return:  API error
...
int EXPORT_TOOLKIT swmm_openOpening(int nodeID, int idx)
//
// Input:   nodeID = Index of desired node
// Return:  API error
